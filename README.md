...
Transcribes the audio with Whisper, then uses GPT-4o to clean it up into readable text with punctuation, capitalization, and timestamped paragraph headings. Two files are written next to the source audio:
